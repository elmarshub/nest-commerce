...
export const metadata: Metadata = {
  title: "Terms of Service - Haven Jewelry",
};
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing and using the Haven Jewelry Inc. website and services, you accept
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              Haven Jewelry Inc.&apos;s website for personal, non-commercial transitory
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              pricing, and availability. However, we do not warrant that product descriptions
              or other content is accurate, complete, reliable, or error-free. We reserve the
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Payment is due at the time of purchase. We accept major credit cards and
                  other payment methods as displayed during checkout. All prices are in USD
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              We will make every effort to ship orders within the timeframes specified.
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              We are not responsible for lost, stolen, or damaged packages once they have
              been delivered to the address provided.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              We want you to be completely satisfied with your purchase. Returns and
              exchanges are accepted within 30 days of delivery, subject to the following
              conditions:
            </p>
            <ul className="list-disc list-inside text-muted-foreground space-y-1">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              logos, images, and software, is the property of Haven Jewelry Inc. and is
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              In no event shall Haven Jewelry Inc. or its suppliers be liable for any damages
              (including, without limitation, damages for loss of data or profit, or due to
              business interruption) arising out of the use or inability to use the materials
              on our website or products, even if we have been notified of the possibility of
              such damage.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              the laws of New York State, and you irrevocably submit to the exclusive
          ...
          <section>
            ...
            <div className="mt-4 text-muted-foreground">
              <p>Email: legal@havenjewelry.com</p>
              <p>Phone: +234 803 345 6789</p>
              <p>Address: 5 Admiralty Way, Lekki Phase 1, Lagos</p>
            </div>
          </section>
        </div>
      </div>
