...
export const metadata: Metadata = {
  ...
  description:
    "Creating beautiful jewelry while protecting our planet for future generations — Haven's environmental commitments and certifications.",
};
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                your Haven jewelry to be recycled into future pieces.
              </p>
            </div>
          </div>
        </div>
      ...
      <ContentSection title="Certifications & Partnerships">
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-4 gap-8 items-center">
            {["RJC Certified", "B Corp", "SCS Certified", "Fair Trade"].map(
              (label) => (
                <div
                  key={label}
